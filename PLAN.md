...
**Project complete (all 8 phases + extras: app-link buttons, PWA manifest/icons, adaptive status polling, README). Next potential steps, in rough priority order:**
...
- **TV IP:** Kconfig `ATV_TV_IP` (menuconfig), currently 192.168.0.104. Upload pinned to 115200 baud (CH340).
